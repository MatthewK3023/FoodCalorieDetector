...
class opts(object):
  def __init__(self): 
    ...
    self.parser.add_argument('--dataset', default='food100',
                             help='food100 | mix_all')
    self.parser.add_argument('--exp_id', default='default')
    self.parser.add_argument('--test', action='store_true')
    self.parser.add_argument('--show_test_acc_log', action='store_true')
    ...
    # model
    self.parser.add_argument('--arch', default='mobilenetv2fpn_10', 
                             help='model architecture. Currently tested'
                                  'res_18 | res_101 | resdcn_18 | resdcn_101 |'
                                  'dlav0_34 | dla_34 | hourglass | mobilenetv2_10 |')
    ...
    self.parser.add_argument('--lr_step', type=str, default='90,100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250',
  ...
  def init(self, args='', target='mixall'):
    default_dataset_info = {
      'ctdet': {'default_resolution': [800, 800], 'num_classes': 1, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'widerface'},
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 100, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'food100'},
      ...
      'ddd': {'default_resolution': [384, 1280], 'num_classes': 3, 
                ...
                'dataset': 'kitti'},
        'mixall': {'default_resolution': [512, 512], 'num_classes': 8, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'mixall'},
        'calall': {'default_resolution': [512, 512], 'num_classes': 8, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'calall'},
        'calface': {'default_resolution': [512, 512], 'num_classes': 4, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'calface'},
        'calbody': {'default_resolution': [512, 512], 'num_classes': 4, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'calbody'},
        'food100': {'default_resolution': [512, 512], 'num_classes': 100, 
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'food100'},
    }
    ...
    opt = self.parse(args)
    print("opt.models  ", opt.load_model)
